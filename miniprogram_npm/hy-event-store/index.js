...
__DEFINE__(1705589097053, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1705589097054,"./event-store":1705589097055}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1705589097054, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1705589097055, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1705589097054,"./utils":1705589097056}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1705589097056, function(require, module, exports) {
...
return __REQUIRE__(1705589097053);
})()
